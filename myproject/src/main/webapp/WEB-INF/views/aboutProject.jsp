...
<head>
  ...
  <title>Stylish Portfolio - My Project</title>
      ...
      <div class="row no-gutters">
        ...
        <div class="col-lg-6">
          <a class="portfolio-item" href="#">
            ...
            <img class="img-fluid" src="resourcesimg/portfolio-2.jpg" alt="">
          </a>
        </div>
        <div class="col-lg-6">
          <a class="portfolio-item" href="#">
            ...
            <img class="img-fluid" src="resourcesimg/portfolio-3.jpg" alt="">
          </a>
        </div>
        <div class="col-lg-6">
          <a class="portfolio-item" href="#">
            ...
            <img class="img-fluid" src="resourcesimg/portfolio-4.jpg" alt="">
          </a>
        </div>
      </div>
    </div>
